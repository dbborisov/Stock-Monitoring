...
public class TestRest {
    ...
    public TestRest(TestWebRead testWebRead, RevolutStokListRepository stokListRepository, RestApiService apiService) {
    ...
    @GetMapping("/test/api/setNewPrices/{stockName}")
    public String setNewPrices(@PathVariable String stockName) {

        return this.apiService.setPricesToStock(stockName).toString();
    }
}